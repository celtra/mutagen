...
// setKubectlVariables sets all Kubectl environment variables to their values
// frozen into the URL.
func setKubectlVariables(environment []string, remote *url.URL) []string {
	// Populate all Kubectl environment variables, overriding any set in the base
	// environment.
	for _, variable := range url.KubectlEnvironmentVariables {
